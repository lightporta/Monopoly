        ...
        <div class="rules-modal">
          ...
          <div class="modal-content">
            <div class="rules-section">
              <h4>🎯 胜利条件（三条件任意达成即获胜）</h4>
              <ul>
                <li><b>破产胜利</b>：使其他所有玩家破产，成为最后存活者。</li>
                <li><b>仙境铁三角胜利</b>：同时持有烟台山、蓬莱阁、养马岛三处地标，且每处地标均建有 3 座房屋（共 9 座）。</li>
                <li><b>资产胜利</b>：总资产率先突破 ¥30000。总资产 = 现金 + 地产 + 建筑 + 养殖场 + 装备 + 投资（均按变卖折价估算）。</li>
              </ul>
            </div>
            <div class="rules-section">
              <h4>🎲 基本规则</h4>
            ...
            <div class="rules-section">
              ...
              <ul>
                <li>初始资金：¥15000</li>
                <li><b>扣款加倍</b>：租金、卡牌罚款、核事故救援费统一 ×2 计算，让游戏更容易分出胜负（过起点奖励、投资分红、养殖收益等盈利项不受影响）</li>
                <li>建造费用 = 地价 × 0.4</li>
            ...
            <div class="rules-section">
              <h4>🃏 机会卡与命运卡</h4>
              <ul>
                <li><b>机会卡</b>（困境牌）：多为正面收益——获得现金、移动到有利格子、抽取美食卡等，助力发展</li>
                <li><b>命运卡</b>（宝藏牌）：机遇与风险并存——可能获得奖励，也可能扣钱、移动到危险格子</li>
                <li>另有<b>生态卡</b>：影响海洋生态指数，可能触发赤潮（养殖收益减半）、台风（养殖场降级）、核事故（扣救援费+停发分红）</li>
                <li>卡牌罚款按扣款加倍规则 ×2 计算</li>
              </ul>
            </div>
            <div class="rules-section">
              <h4>⚡ 特殊格子</h4>
            ...
            <div class="rules-section">
              <h4>🏠 色块分组与各地作用</h4>
              <ul>
                <li>🔴 历史街区（所城里、朝阳街、烟台山、张裕酒文化博物馆，4块）：全部集齐 ×2.0</li>
                <li>🔵 海岸线（芝罘湾广场、月亮湾、东炮台、渔人码头、黄海明珠、长岛、万鸟岛、金沙滩，8块）：集齐4块 ×1.5</li>
                <li>🟢 仙山（马山寨、养马岛、昆嵛山、蓬莱阁、三仙山，5块）：全部集齐 ×2.0</li>
                <li>🟠 温泉（龙泉温泉、龙湖北中国海、磁山温泉、天马栈桥，4块）：全部集齐 ×2.0</li>
            ...
            <div class="rules-section">
              <h4>🤖 AI 难度说明（人机模式）</h4>
              <ul>
                <li><b>简单（新手导游）</b>：AI 决策保守、随机性强，不主动交易和集齐色块，建房慢，最容易击败</li>
                <li><b>普通（本地商人）</b>：AI 按基础性价比决策，中庸水平</li>
                <li><b>困难（仙境霸主）</b>：AI 积极集齐色块、优先补齐建筑、会抄底买地皮、积极投资，最具挑战</li>
              </ul>
            </div>
          </div>
