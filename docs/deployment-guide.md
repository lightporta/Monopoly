...
> **文档版本**：V3.7| 2026-07-13

---

## 目录

- [一、云服务器选购（学生优惠或其他优惠）](#一云服务器选购学生优惠)
- [二、服务器环境准备](#二服务器环境准备)
...
如果是作为学生，你可以享受多家云厂商的学生优惠。本游戏是 Node.js WebSocket 联机游戏，**同时在线几十人以内**，2核2G 配置完全够用。
...
2. 学信网学籍认证（学生证/录取通知书，系统自动对接，几分钟通过）
